		...
		return new Promise(function (resolve, reject) {
			_this.applyAuthToRequest(requestParams, headers, oauth2client, credentials).then(function () {
				...
				const axiosOptions = {
					...
					decompress: headers['Accept-Encoding'] === 'gzip, deflate' ? false : true,
				};

				if (axiosOptions.decompress === false) 
					axiosOptions.responseType = 'arraybuffer'; // to avoid axios to convert the response to string
